...
private val initialMessages = listOf(
    ...
    Message(
        "John Glenn",
        "Glad you asked! The recommended way is to use the `Flow.collectAsStateWithLifecycle()` " +
            "APIs. They're lifecycle-aware and handle the async data loading for you. " +
            "You can use all the same stuff you're used to with `LiveData`.",
        "8:04 PM"
    ),
    Message(
        "me",
